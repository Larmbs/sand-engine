...
use macroquad::{
    prelude::{
        ...
        gl_use_default_material, gl_use_material, load_material, mouse_position,
        Color, Material, MaterialParams, ShaderSource, UniformType, BLACK, BLUE, PINK,
        RED, WHITE,
    },
    window,
};
...
impl Camera {
    ...
    fn draw_debug_menu(&self, regions: usize) {
        ...
        draw_text(
            format!("Regions Loaded: {}", regions).as_str(),
            16.,
            50.,
            32.,
            BLACK,
        ...
        draw_text(
            format!("Zoom Level: {}", self.zoom).as_str(),
            16.,
            66.,
            32.,
            BLACK,
